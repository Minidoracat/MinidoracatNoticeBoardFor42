...
# MinidoracatNoticeBoardFor42 Minidoracat Notice Board for B42
...
# 主選單
# ============================================
$Host.UI.RawUI.WindowTitle = "PZ Mod Test Launcher - MinidoracatNoticeBoardFor42"

while ($true) {
    Clear-Host
    Write-Host "========================================" -ForegroundColor Cyan
    Write-Host "  Project Zomboid MOD 測試啟動器" -ForegroundColor Cyan
    Write-Host "  MinidoracatNoticeBoardFor42 Minidoracat Notice Board for B42" -ForegroundColor Cyan
    Write-Host "========================================" -ForegroundColor Cyan
    Write-Host ""
    Write-Host "  [1] 啟動客戶端"
